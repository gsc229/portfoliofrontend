...
export default function FeaturedProjects({
  ...
  return (
    <div style={{ height: `${height}px` }} id="top-banner" unit="billboard">
      <div className="photo-credit">
        <p>
          Photographer: Mario Konang: &nbsp;{" "}
          <a href="https://gregs-nasa-apod.netlify.app/">
            NASA Photo Of The Day 4/7/20
          </a>
        </p>
      </div>
      <Container id="banner-inner-container">
        ...
        <div id="banner-inner-right" centered="true">
          <div className="header-container">
            <Header size="huge">
              <h1>
                Hi. I'm <strong>Greg Cameron</strong>.
              </h1>
            </Header>
            <p>
              And this is my &nbsp;
