    ...
    >
      ...
      <Menu>
        <Menu.Item
          ...
          style={{
            backgroundColor: activeTech === "React" ? "#61DAFB" : "white",
          }}
        >
          <i
            style={{
        ...
        <Menu.Item
          ...
          style={{
            backgroundColor: activeTech === "Django" ? "#0EA44B" : "white",
          }}
        >
          <i
            style={{
              ...
              margin: "auto",
              cursor: "pointer",
              color: activeTech === "Django" ? "white" : "#0EA44B",
            }}
            id="django"
            className="devicon-django-plain-wordmark skill-logo"
          ></i>
        </Menu.Item>
      </Menu>
    </div>
